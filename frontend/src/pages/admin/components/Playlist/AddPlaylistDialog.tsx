...
const AddPlaylistDialog = () => {
  ...
  useEffect(() => {
    console.log(
      "🟢 Syncing newPlaylist.category with selectedCategories:",
      selectedCategories
    );
    setNewPlaylist((prev) => ({ ...prev, category: selectedCategories }));
  }, [selectedCategories]); // ✅ Ensures `newPlaylist.category` is always up-to-date
